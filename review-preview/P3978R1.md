# [P3978R1](https://github.com/cppalliance/paperlint/blob/feature/sd4-rubric-v2/output-sd4-v4/P3978R1/paper.md) - constant_wrapper should unwrap on call and subscript
